...
(function($) {
    "";
    "use strict";
    var defaults = {autoPlay: true, speed: 5000, 
        text: {play: "", stop: "", previous: "Previous", next: "Next", loading: "Loading"},
        transition: [1], showCaption: true, IESafe: false, showTooltips: false, carousel: true,
        swipe: true, carouselVertical: false, animationFinished: null, buildFinished: null, bindsFinished: null,
        startOn: 0, thumbOpacity: 0.4, hoverPause: false, animationSpeed: 600, fadeThumbsIn: false, 
        carouselOptions: {}, thumbChangeEvent: 'click.pikachoose', stopOnClick: false, hideThumbnails: false};
    ...
    $pc.fn.extend({build: function() {
            ...
            this.image = $("<img id='changeimg'>").appendTo(this.wrap);
            ...
            var img = new Image();
            var imagelr = data.source;
            var imagehr = imagelr.replace('LR','HR');
            $(img).attr('src', imagehr);
            ...
            self.aniDiv.children().each(function() {
                ...
                div.css({'background': 'url(' + imagehr + ') -' + xOffset + 'px -' + yOffset + 'px', 'background-size': div.parent().width() + 'px ' + div.parent().height() + 'px', 'width': '0px', 'height': '0px', 'position': 'absolute', 'top': yOffset + 'px', 'left': xOffset + 'px', 'float': 'none'});
            });
            self.aniDiv.hide();
            self.aniImg.hide();
            switch (n) {
                case 0:
                    self.image.stop(true, true).fadeOut(self.options.animationSpeed, function() {
                        self.image.attr('src', imagehr).fadeIn(self.options.animationSpeed, function() {
                ...
                case 1:
                    self.aniDiv.hide();
                    self.aniImg.height(self.image.height()).hide().attr('src', imagehr);
                ...
                case 5:
                    ...
                    break;
                case 6:
                    self.aniDiv.height(self.image.height()).hide().css({'background': 'url(' + imagehr + ') top left no-repeat'});
            ...
            this.animating = false;
            var imglr = data.source;
            var imghr = imglr.replace('LR','HR');
            this.image.attr('src', imghr);
