...
//            $sql = PluSQL::from($this->profile)->res_prop->select("*")->where("")->orderby("list_price ASC, res_prop_id")->limit("0,3")->run()->res_prop;
    ...
    public function suburbs_values() {
        try {
            ...
            //$sql = PluSQL::from($this->profile)->res_prop->select("*")->orderby("list_price ASC, res_prop_id")->limit("3,3")->run()->res_prop;
    ...
    public function newlisting_values() {
        try {
            ...
            //$sql = PluSQL::from($this->profile)->res_prop->select("*")->orderby("list_price ASC, res_prop_id DESC")->limit("6,3")->run()->res_prop;
    ...
    public function recently_reduced_values() {
        ...
        try {
            ...
            //$sql = PluSQL::from($this->profile)->res_prop->select("*")->orderby("list_price ASC, res_prop_id DESC")->limit("9,3")->run()->res_prop;
