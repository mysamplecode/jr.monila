...
class  Dbconfig
{
	...
	private static $db_name = 'paperfli_jrm';
	private static $db_user = 'paperfli_jrm';
	private static $db_password = 'bugs123';
	...
	const DB_NAME = 'paperfli_jrm';
	const DB_USER = 'paperfli_jrm';
	const DB_PASSWORD = 'bugs123';
	const DB_DUMP = 'DB_DUMP';
	//
