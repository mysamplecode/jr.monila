...
Element.extend({
	...
	*/
	...
	Property: setStyle
		...
		Example:
			>$('myElement').setStyle('width', '900px'); //the width is now 300px
			>$('myElement').setStyle('width', 900); //the width is now 300px
	*/
	...
	Examples:
		...
		>$('myElement').setStyles('border: 1px solid #000; width: 900px; height: 400px;');
	*/
	...
	*/
	...
	Example:
		>$('myElement').getStyle('width'); //returns "900px"
