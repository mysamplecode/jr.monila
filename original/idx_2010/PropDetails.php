...
<script type="text/javascript">
		...
		$('ul.gallery_demo').galleria({
			...
			onImage   : function(image,caption,thumb) { // effect
				...
				image.css('margin','105px 0px 0px 10px')
				image.css('div','10px')
...
<body id="www-jrmolina-com" class="our-listings">
<ul id="accessibility">
...
?>
					  ...
					  <div id="listing-description" class="vevent clearfix">
						...
						<table align="left" class="clearfix" id="property-detail">
							<thead>
					...
					<th scope="row" colspan="2"><br />Special Features</th>
