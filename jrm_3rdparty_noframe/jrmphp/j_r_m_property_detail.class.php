                            ...
                            foreach ($sql_image as $si) {
                                ...
                                if (file_exists($imagepath)) {
                                    if (imagecreatefromjpeg($imagepath) !== FALSE) {
                                        $imageli->setValue('#res_image@src', PACKAGES_DIR . '/jrmimages/' . $si->image_path);
                                        $imagelii->setValue('#res_image_all@src', PACKAGES_DIR . '/jrmimages/' . str_replace('LR', 'HR', $si->image_path));
                                        $imageli->next();
                                        $imagelii->next();
                                    } else {
