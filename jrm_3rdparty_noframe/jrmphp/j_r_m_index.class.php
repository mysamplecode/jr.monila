<?php
include_once '../Config/r_s_base.class.php';
...
class JRMIndex extends RSBase {
    ...
    public function dallas_values() {
        ...
        try {
            ...
            return $this->thumbview_query($sq, "DESC", "0, 3");
    ...
    public function suburbs_values() {
        try {
            ...
            return $this->thumbview_query($sq, "DESC", "3, 3");
    ...
    public function newlisting_values() {
        try {
            return $this->thumbview_query("", "DESC", "6, 3");
